import { AddTeamsPage, ChooseTournamentType, AddTeamPage, addTeamAction, teamsLoader } from '@/pages/CreateTournamentPage';
...
import { ErrorBoundaryError } from '@/components/Root';

const RouteError = () => {
  const error = useRouteError();
  return <ErrorBoundaryError error={error} />;
};
